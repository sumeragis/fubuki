...
### Phase 1: Plan
1. `data/pdca-log/` の最新ログを確認（前サイクルの引き継ぎ事項を把握）
2. `data/eval/reports/` の最新評価レポートを確認（あれば）
...
18. 改善ログを `data/pdca-log/YYYY-MM-DD.md` に書き込む（必須）
    - 今サイクルで分かったこと（数値ではなく解釈・示唆）
    - 実施した改善とその意図、見送った提案と理由
    - 次サイクルへの具体的な引き継ぎ事項
